...
To use these stylesheets, rename the files and simpler with the name of your theme.
...
simpler-alpha-default-narrow.css  
...
simpler-alpha-default-normal.css
...
simpler-alpha-default-wide.css
